# Metro Line QA Checklist

Use this checklist before publishing each line pair.
...
- [ ] `data/en/<line-id>.md` exists
- [ ] `data/zh/<line-id>.md` exists
- [ ] EN and ZH have same fact set
- [ ] EN and ZH section order matches
- [ ] Names/translations are consistent with project conventions

## E. Final Gate
- [ ] File names match line ID
