# Metro Line Markdown Template

Use this structure for both English and Chinese files.
...
## Word Helper
- <Term>: <Simple child-friendly explanation>
- <Term>: <Simple child-friendly explanation>
- <Term>: <Simple child-friendly explanation>
...
- Extension: A new part added later.
```
