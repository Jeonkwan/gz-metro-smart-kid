# Haizhu Tram — Guangzhou's River-Side Wonder
...
## Story Time
Haizhu Island sits in the heart of Guangzhou, surrounded by the Pearl River.
In the early 2010s, the northern shore of the island was becoming busier.
...
Today, it still carries commuters and tourists along the scenic Pearl River every day.
...
## Fun Facts
- The Haizhu Tram was the world's first fully catenary-free (no overhead wire) supercapacitor tram line when it opened in 2014.
- The front of each tram is shaped to subtly resemble the Chinese character "广" (guǎng) — the first character of "Guangzhou."
- The tram's supercapacitors can recharge in under 60 seconds at each station stop.

## Word Helper
- **Supercapacitor:** A special device that stores a large amount of electricity and can be filled up very quickly — like a super-fast rechargeable battery.
- **Catenary:** The overhead wire that usually gives trams and trains their electricity. The Haizhu Tram has no catenary — it is completely wire-free!
- **Tram:** A rail vehicle that runs on tracks laid in the street, usually sharing the road with cars and buses.
