# 🔵 Guangzhou Metro Line 2 — The North–South Connector!
...
Before Line 2, getting from one end of Guangzhou to the other was slow and crowded.
Buses and roads were packed, especially through the busy city center.
City planners wanted a fast rail line that would run north to south, connecting homes, parks, and big railway stations.
...
- **Crossing the Pearl River underground**: The Pearl River runs through the middle of Guangzhou. Building a tunnel under a wide river with soft, watery soil was very hard. Engineers had to use special boring machines and keep the water out while digging deep below.
- **Building under a busy city without stopping it**: Guangzhou's center is full of roads, buildings, and people. Digging tunnels below all of that — without damaging anything above — took very careful planning and constant checking.
- **Separating a shared track**: The early Line 2 and what would later become Line 8 shared the same stretch of track in the city center. In 2010, workers had to separate the two lines underground so that each could run on its own. That kind of work deep underground takes years to plan carefully.
...
The metro station connects Line 2 and Line 5 in one spot, making it a very busy place.
For many decades, this station has been a major gateway into Guangzhou.

### 3) Guangzhou South Railway Station (广州南站)

This is one of the largest high-speed train stations in all of China.
It has 28 platforms — that is like 28 separate tracks where trains can stop side by side.
High-speed trains from here can reach Beijing, Shanghai, and many other cities in just a few hours.
The metro brings you right into the lower level of this enormous station.
...
- **Trunk line**: A main route that carries many people along a city's central corridor.
- **High-speed train**: A very fast train that can travel at hundreds of kilometers per hour.
- **Multi-modal hub**: A place where you can switch between different types of transport, such as metro, national trains, and buses.
...
- UrbanRail.Net – Guangzhou Metro: https://www.urbanrail.net/as/cn/guan/guangzhou.htm
- Sun Yat-sen Memorial Hall station – Wikipedia: https://en.wikipedia.org/wiki/Sun_Yat-sen_Memorial_Hall_station_(Guangzhou_Metro)
- Sun Yat-sen Memorial Hall – Guangzhou Travel Guide: https://guangzhoutravelguide.com/sun-yat-sen-memorial-hall-guangzhou/
- Guangzhou Metro Line 2 – Baidu Encyclopedia: https://baike.baidu.com/en/item/Guangzhou%20Metro%20Line%202/663863
