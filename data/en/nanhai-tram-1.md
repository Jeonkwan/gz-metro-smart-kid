# Nanhai Tram Line 1 — Foshan's Urban Link

## Quick Intro
Nanhai Tram Line 1 is a modern tram line in Nanhai District, Foshan.
It is about 14.3 kilometres long with 15 stations.
The first section opened on August 18, 2021, and the full line opened on November 29, 2022.
The tram connects Nanhai's residential and commercial areas to the wider Guangzhou–Foshan metro network.

## Story Time
Nanhai District is a busy part of Foshan, sitting right next to Guangzhou.
People living in Nanhai often travel to both Foshan and Guangzhou for work and school.
Before the tram opened, some areas between Guilin, Pingzhou, Sanshan, and Linyue had limited public transit.
Residents had to rely heavily on buses or private cars.
...
### 3) Linyuedong (林岳东)
This is the southern end of the line, where you can transfer to Foshan Metro Line 2.
"Linyue" (林岳) means "forest mountains" — a peaceful, natural-sounding name for the end of the journey.

## Fun Facts
- Nanhai Tram Line 1 travels through three types of track on one single journey: underground tunnels, elevated bridges, and street-level roads.
- Construction planning started in 2011, more than ten years before the full line opened in 2022.
- The tram passes Wenhanhu Park station, located near Ji Hua Laboratory — one of Foshan's leading science research centres.

## Word Helper
- **Elevated section:** Part of a tram or train route that runs on a raised platform above street level, like a bridge in the sky.
- **Underground section:** Part of the route that goes through a tunnel beneath the ground.
- **Interchange:** A station where passengers can switch from one transport line to another.
