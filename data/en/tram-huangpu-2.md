# Huangpu Tram Line 2 — Growing into Huangpu's Future
...
### 1) Xiangxue Metro Station (香雪站)
This is the northern starting station — shared with Huangpu Tram Line 1.
It is the link between the tram and Metro Line 6, which reaches many other parts of Guangzhou.
"Xiangxue" (香雪) means "fragrant snow," named for white plum blossoms that bloom nearby every winter.

### 2) Kaiyuan Avenue East (开元大道东)
This is the current southern end of the line.
...
## Word Helper
- **Extension:** Adding more track and stations to make a transport line longer and reach more places.
- **Corridor:** A path or stretch of land along which a transport line runs.
- **Terminus:** The first or last station on a transport line.
