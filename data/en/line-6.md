# 🟣 Guangzhou Metro Line 6 — The Culture Trail!
...
In 2016, the line was extended eastward to Xiangxue (香雪) in Huangpu District.
Today, Line 6 connects history, art, and modern suburbs across 32 stations.

## Story Time

Before Line 6, the historic Dongshan area in eastern Guangzhou had narrow streets and heavy traffic.
Many old neighborhoods had beautiful buildings but were hard to reach quickly.
...
In 2016, the eastern extension reached the growing Xiangxue (香雪) area in Huangpu District.
...
- **2013**: Phase 1 opened on December 28, running from Xunfenggang (Transfer to Line 12) to Changban through the historic city center.
- **2016**: The eastern extension opened on December 28, reaching Xiangxue (香雪) in Huangpu District.
...
- **Shahe (Transfer to Line 11) Station construction**: Building the station at Shahe (Transfer to Line 11) was extremely difficult due to complex ground conditions and the need to protect surrounding buildings, leading it to open later than the rest of the line.

## Route Snapshot

- **Start area**: Xunfenggang (Transfer to Line 12) (浔峰岗), western terminus in Baiyun District
...
- **Transfer value**: Connects with Line 1 at Huangsha (黄沙) and Dongshan Kou; to Line 5 at Tanwei (Transfer to Line 6) and Ouzhuang (Transfer to Line 6); to Line 3 at Yantang (Transfer to Line 3) and Tianhe Coach Terminal (Transfer to Line 3); to Line 21 at Suyuan (Transfer to Line 21); and to Line 7 at Luogang (萝岗).

## Full Station List

1. **Xunfenggang (Transfer to Line 12)** (Transfer to Line 12)
2. **Hengsha**
3. **Shabei**
4. **Hesha**
5. **Tanwei (Transfer to Line 6)** (Transfer to Line 5)
6. **Ruyifang (Transfer to Line 11)** (Transfer to Line 11)
7. **Huangsha (黄沙)** (Transfer to Line 1)
8. **Cultural Park (Transfer to Line 8)** (Transfer to Line 8)
9. **Yide Lu**
10. **Haizhu Square (海珠广场)** (Transfer to Line 2)
11. **Beijing Lu**
12. **Tuanyida Square**
13. **Donghu (Transfer to Line 10 & Line 12)** (Transfer to Line 10 & Line 12)
14. **Dongshankou (东山口)** (Transfer to Line 1)
15. **Ouzhuang (Transfer to Line 6)** (Transfer to Line 5)
16. **Huanghuagang**
17. **Shaheding**
18. **Shahe (Transfer to Line 11)** (Transfer to Line 11)
19. **Tianpingjia**
20. **Yantang (Transfer to Line 3)** (Transfer to Line 3)
21. **Tianhe Coach Terminal (Transfer to Line 3)** (Transfer to Line 3)
22. **Changban**
23. **Botanical Garden**
24. **Longdong**
25. **Kemulang**
...
28. **Jinfeng**
29. **Xiangang**
30. **Suyuan (Transfer to Line 21)** (Transfer to Line 21)
31. **Luogang (萝岗)** (Transfer to Line 7)
32. **Xiangxue (香雪)** (Transfer to Huangpu Tram 1)

## Important Stations for Kids

### 1) Dongshan Kou (东山口)

Dongshan Kou means "East Mountain Mouth."
This neighborhood is famous for old buildings from the Republican era, which lasted from 1912 to 1949.
The buildings have arched windows, colorful tiles, and carved doorways.
Walking around there feels like stepping into a history book!

### 2) Cultural Park (Transfer to Line 8) (文化公园)

Cultural Park (Transfer to Line 8) station is next to Guangzhou's historic Cultural Park (Transfer to Line 8).
The park has been a home for art shows, performances, and cultural festivals for many decades.
Children can visit the park to see exhibitions and enjoy the open spaces.
It is one of the most well-known public parks in Guangzhou's old city.

### 3) Huangsha (黄沙)

Huangsha (黄沙) station sits near the Pearl River and the famous Shamian Island (沙面).
Shamian Island is covered with old European-style buildings built during the late 1800s and early 1900s.
Here you can transfer to Line 1 and continue your journey across the city.
It is a great place to explore history from two different parts of the world in one spot!
...
- **Republican era**: A period in Chinese history from 1912 to 1949. Many of Guangzhou's most famous old buildings were built during this time.
- **Extension**: When a metro line is made longer by adding new stations at one end.
- **Transfer station**: A station where you can switch from one metro line to another.

## Memory Check

1. In which year did the first part of Line 6 open?
...
- Line 6 (Guangzhou Metro) — Wikipedia: https://en.wikipedia.org/wiki/Line_6_(Guangzhou_Metro)
- Dongshan, Guangzhou — Wikipedia: https://en.wikipedia.org/wiki/Dongshan,_Guangzhou
- Guangzhou Cultural Park — Wikipedia: https://en.wikipedia.org/wiki/Guangzhou_Cultural_Park
- Shamian Island — Wikipedia: https://en.wikipedia.org/wiki/Shamian_Island
- Huangsha station — Wikipedia: https://en.wikipedia.org/wiki/Huangsha_station
