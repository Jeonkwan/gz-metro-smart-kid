# 🟠 Guangzhou Metro Line 3 — The Y-Shaped Airport Adventure!
...
By the early 2000s, Guangzhou was growing very fast.
Many people were moving into the south of the city, near Panyu District.
...
### 2) Guangzhou East Railway Station (广州东站)

This station connects the metro to a large national railway station.
Trains from here travel toward Shenzhen and Hong Kong.
It is a transfer station for both Line 1 and Line 3, making it a very important underground crossroads.

### 3) Airport North (机场北)

This is the final stop at Baiyun International Airport Terminal 2.
When you step off Line 3 here, you are already inside the airport area.
Millions of travelers use this station every year to start or finish their journeys.
It is very exciting to ride a metro train all the way to an airport!

## Fun Facts

- Line 3 is about **74.8 kilometers** long — one of the longest fully underground metro lines in the world!
- It has **34 stations**, all underground.
- Trains on Line 3 can travel at up to **120 km/h** — faster than most city metro lines.
- On the busiest days, Line 3 has seen nearly **2.8 million** riders in a single day.

## Word Helper

- **Y-shaped line**: A metro line that splits into two different paths at one station, like the letter Y.
- **Terminal**: An airport building where travelers check in, wait, and board planes.
- **Express corridor**: A route designed to carry many people over a long distance very quickly.

## Memory Check

1. In which year did Line 3 first open?
...
- Tiyu Xilu Station – Wikipedia: https://en.wikipedia.org/wiki/Tiyu_Xilu_Station
- Guangzhou Metro Line 3 – Baidu Encyclopedia: https://baike.baidu.com/en/item/Guangzhou%20Metro%20Line%203/943622
- East Extension of Line 3 Opens – Life of Guangzhou: https://www.lifeofguangzhou.com/content/202411/04/170602_54741391.htm
- Guangzhou Metro Line 3 Timetable and Stations – TravelChinaGuide: https://www.travelchinaguide.com/cityguides/guangdong/guangzhou/subway/line3.htm
